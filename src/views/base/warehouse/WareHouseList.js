...
const columns = [
  ...
  { id: 'name_another', label: 'Tên khác', minWidth: 130, align: 'center' },
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('response brand:', response.data.data)
      } catch (error) {
                ...
                {warehouse
                  ...
                  .map((row) => (
                    <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
                      ...
                      <TableCell style={{ textAlign: 'center' }}>{row.ten_kho}</TableCell>
                      <TableCell style={{ textAlign: 'center' }}>{row.ten_kho2}</TableCell>
                      <TableCell style={{ textAlign: 'center' }}>{row.dia_chi}</TableCell>
                      ...
                      <TableCell style={{ textAlign: 'center' }}>
                        <Link style={{ marginRight: '10px' }} to={`/category/update/${row.id}`}>
                          <EditIcon />
                        </Link>
                      </TableCell>
                    </TableRow>
