...
export default function ImageSaleRightHomeList() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${API_URL}/api/imageRightHome/getAll`)
            ...
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {slideHome
                  ...
                  .map((row) => (
                    <TableRow hover role="checkbox" tabIndex={-1} key={row.ImageBannerID}>
                      <TableCell style={{ textAlign: 'center' }}>{row.ImageBannerID}</TableCell>
                      ...
                      <TableCell style={{ textAlign: 'center' }}>
                        <Link
                          ...
                          to={`/imageSaleRightHome/update/${row.ImageBannerID}`}
                        >
                          <EditIcon />
                        </Link>
                      </TableCell>
